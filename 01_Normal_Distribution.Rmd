...
As described, the y axis shows cumulative probability so you will notice that the function is always increasing. Here is a simulation to allow you to explore the normal pdf and cdf simultaneously. 

<center>
```{r pdfandcdf}
r2d3(script="widgets/01/norm-pdf-cdf.js", width = 800, height = 500)
```
</center>
